...
def exp(s):
    ...
    Y, X, T, Phi, P = get_observations_sparse_linear_markovian(n_exploration, x_dim, L, A, B, C, alpha, beta, gamma, rct_agents, phi, estimate_psi, "normal", noise_std, 0)
    ...
    results, return_weights, sum_vars, return_H0 = get_estimates(Y, X, T, estimate_psi, P, thetas, betas, kappas, A, B, C, noise_std, 
                                                             ...
                                                             fit_oracle=False, current_batch_size=n_exploration, sum_vars=np.zeros(L), verbose=False)
    ...
    for b in range(1, n_batches):
        ...
        # Draw observations
        Y_b, X_b, T_b, Phi_b, P_b = get_observations_sparse_linear_markovian(batch_size, x_dim, L, A, B, C, alpha, beta, gamma, agents, phi, estimate_psi, "normal", noise_std, floor)
